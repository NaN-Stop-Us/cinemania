import{a as b}from"./vendor-DDD7fsZd.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function o(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(s){if(s.ep)return;s.ep=!0;const a=o(s);fetch(s.href,a)}})();window.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("theme-toggle"),t=document.body;localStorage.getItem("theme")==="light"&&t.classList.add("light-theme"),e.addEventListener("click",()=>{t.classList.toggle("light-theme");const r=t.classList.contains("light-theme");localStorage.setItem("theme",r?"light":"dark")})});window.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("menu-btn"),t=document.getElementById("nav"),o=document.getElementById("fog");e.addEventListener("click",()=>{t.classList.toggle("shown"),o.classList.toggle("active")}),o&&t&&o.addEventListener("click",()=>{t.classList.remove("shown"),o.classList.remove("active")})});const E="ed2682fe1cd0ecc2efbcdeb7464c5ffd",y="https://api.themoviedb.org/3",S="https://image.tmdb.org/t/p",p={POPULAR_MOVIES:"/movie/popular",UPCOMING_MOVIES:"/movie/upcoming",TRENDING_WEEK:"/trending/movie/week",TRENDING_DAY:"/trending/movie/day",SEARCH_MOVIES:"/search/movie",GENRE_LIST:"/genre/movie/list",MOVIE_DETAILS:e=>`/movie/${e}`,MOVIE_VIDEOS:e=>`/movie/${e}/videos`,IMG_ORIGINAL:"/original",IMG_W500:"/w500",IMG_W780:"/w780",IMG_W1280:"/w1280"};async function w(e,t,o={}){try{return(await b.get(`${e}${t}`,{params:{api_key:E,language:"en-US",page:1,...o}})).data}catch(r){throw console.error("Error fetching data:",r),r}}async function M(){try{const e=await b.get(`${y}${p.GENRE_LIST}`,{params:{api_key:E,language:"en-US"}}),t={};return e.data.genres.forEach(o=>{t[o.id]=o.name}),t}catch(e){return console.error("Error fetching genres:",e),{}}}const m="myLibrary";function _(e){const t=JSON.parse(localStorage.getItem(m))||[];t.some(o=>o.id===e.id)||(t.push(e),localStorage.setItem(m,JSON.stringify(t)))}function O(e){let t=JSON.parse(localStorage.getItem(m))||[];t=t.filter(o=>o.id!==e),localStorage.setItem(m,JSON.stringify(t))}function L(e){return(JSON.parse(localStorage.getItem(m))||[]).some(o=>o.id===e)}let g={};(async()=>g=await M())();const u=document.querySelector("#catalog-hero"),l=document.getElementById("trailer-modal");u?x():console.log("Catalog hero element not found, skipping initialization");function k(e){const t=Math.floor(Math.random()*e.length);return e[t]}async function $(e){try{const o=(await w(y,p.MOVIE_VIDEOS(e))).results.find(r=>r.type==="Trailer"&&r.site==="YouTube");return o?`https://www.youtube.com/embed/${o.key}`:null}catch{return null}}function G(e){l.innerHTML=`
  ...
  `,l.classList.add("active"),l.querySelector(".overlay").addEventListener("click",v),l.querySelector(".close-span-btn").addEventListener("click",v)}function v(){l.classList.remove("active"),l.innerHTML=""}function T(e,t){if(typeof e!="number"||e<0||e>10){console.error("Rating must be a number between 0 and 10");return}const o=`
...
<stop offset="1" stop-color="#F89F19" stop-opacity="0.68"/>
...
</svg>`,a=e/2,i=Math.floor(a),c=a%1>=.5?1:0,f=5-i-c;t.innerHTML="";const d=n=>{const h=document.createElement("div");h.innerHTML=n.trim();const I=h.firstElementChild;t.appendChild(I)};for(let n=0;n<i;n++)d(o);c&&d(r);for(let n=0;n<f;n++)d(s)}async function x(){try{const e=await w(y,p.POPULAR_MOVIES),t=k(e.results),o=`${S}${p.IMG_W1280}${t.backdrop_path}`;u.style.backgroundImage=`url('${o}')`,u.innerHTML=`
    ...
    `;const r=u.querySelector(".stars");T(t.vote_average,r),u.querySelector(".more-details").addEventListener("click",()=>{N(t)}),u.querySelector(".watch-trailer").addEventListener("click",async()=>{const s=await $(t.id);s?G(s):(l.innerHTML=`
          <div class="overlay"></div>
  ...
  `,o.classList.add("active");const i=o.querySelector(".add-library");i.addEventListener("click",()=>{L(e.id)?(O(e.id),i.textContent="Add to My Library"):(_(e),i.textContent="Remove from My Library"),typeof t=="function"&&t()});function c(){o.classList.remove("active"),o.innerHTML="",document.removeEventListener("keydown",f)}const f=n=>{n.key==="Escape"&&c()};document.addEventListener("keydown",f),o.querySelector(".close-span-btn-details").addEventListener("click",c),o.querySelector(".detail-overlay").addEventListener("click",c)}(()=>{const e=document.querySelector('[data-modal-open="footer"]'),t=document.querySelector('[data-modal-close="footer"]'),o=document.querySelector('[data-modal="footer"]'),r=document.querySelector(".students-overlay audio");new Audio("./sound/imperial-march.mp3"),e.addEventListener("click",()=>{s(),r&&(r.currentTime=0,r.play().catch(a=>console.error("Ses çalma hatası:",a)))}),t.addEventListener("click",()=>{s(),r&&(r.pause(),r.currentTime=0)}),o.addEventListener("click",a=>{a.target===o&&s()}),document.addEventListener("keydown",a=>{a.key==="Escape"&&!o.classList.contains("is-hidden")&&s()});function s(){o.classList.toggle("is-hidden")}})();export{y as B,p as E,S as I,w as a,_ as b,T as c,M as f,L as i,O as r,N as s};
//# sourceMappingURL=footer-DLG_b0B6.js.map

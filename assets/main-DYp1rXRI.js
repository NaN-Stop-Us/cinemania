import{f as k,a as l,B as d,E as p,s as u,I as y,r as $}from"./catalog-hero-Cc6sBTQF.js";import"./footer-2FzYERtW.js";const g=document.querySelector("#weekly-trends-list"),c=document.getElementById("upcoming-card");let m={};(async()=>m=await k())();function M(t){return t.slice(0,3)}function E(t){const r=t.map(n=>{const{id:a,title:e,poster_path:s,release_date:i,vote_average:_,genre_ids:o}=n,h=i?i.slice(0,4):"N/A",v=s?`${y}/w500${s}`:"https://via.placeholder.com/395x574?text=No+Image",w=(o==null?void 0:o.map(f=>m[f]).join(", "))||"";return`
      <li class="weekly-card" data-id="${a}" data-rating="${_}">
...
//# sourceMappingURL=main-DYp1rXRI.js.map

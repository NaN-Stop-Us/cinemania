...
<stop offset="1" stop-color="#F89F19" stop-opacity="0.68"/>
...
</svg>`,n=e/2,i=Math.floor(n),c=n%1>=.5?1:0,f=5-i-c;t.innerHTML="";const d=a=>{const L=document.createElement("div");L.innerHTML=a.trim();const I=L.firstElementChild;t.appendChild(I)};for(let a=0;a<i;a++)d(o);c&&d(r);for(let a=0;a<f;a++)d(s)}async function x(){try{const e=await w(y,p.POPULAR_MOVIES),t=k(e.results),o=`${S}${p.IMG_W1280}${t.backdrop_path}`;u.style.backgroundImage=`url('${o}')`,u.innerHTML=`
  ...
  `,o.classList.add("active");const i=o.querySelector(".add-library");i.addEventListener("click",()=>{h(e.id)?(O(e.id),i.textContent="Add to My Library"):(_(e),i.textContent="Remove from My Library"),typeof t=="function"&&t()});function c(){o.classList.remove("active"),o.innerHTML="",document.removeEventListener("keydown",f)}const f=a=>{a.key==="Escape"&&c()};document.addEventListener("keydown",f),o.querySelector(".close-span-btn-details").addEventListener("click",c),o.querySelector(".detail-overlay").addEventListener("click",c)}(()=>{const e=document.querySelector('[data-modal-open="footer"]'),t=document.querySelector('[data-modal-close="footer"]'),o=document.querySelector('[data-modal="footer"]'),r=new Audio("./sound/imperial-march.mp3");e.addEventListener("click",s),e.addEventListener("click",()=>{r.play()}),t.addEventListener("click",s),o.addEventListener("click",n=>{n.target===o&&s()}),document.addEventListener("keydown",n=>{n.key==="Escape"&&!o.classList.contains("is-hidden")&&s()});function s(){o.classList.toggle("is-hidden")}})();export{y as B,p as E,S as I,w as a,_ as b,T as c,M as f,h as i,O as r,N as s};
//# sourceMappingURL=footer-DW6wAYjZ.js.map

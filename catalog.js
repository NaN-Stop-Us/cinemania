import{a as f,B as L,E as u,f as O,I as C,r as _,i as I,b as $,c as H}from"./assets/footer-DPzAl7vK.js";import"./assets/vendor-DDD7fsZd.js";const c=document.getElementById("searchInput"),T=document.getElementById("yearFilter"),P=document.getElementById("searchBtn"),w=document.getElementById("movieResults"),E=document.getElementById("noResult");let m=1,S=1;document.addEventListener("DOMContentLoaded",()=>{W()});document.addEventListener("DOMContentLoaded",async()=>{try{const e=await f(L,u.UPCOMING_MOVIES,{page:m});S=e.total_pages,M(e.results),x(m,S)}catch(e){E.innerHTML="<p>OOPS... We are very sorry! We don`t have any results matching your search. </p>",console.error("Upcoming fetch hatası:",e)}});let y={};document.addEventListener("DOMContentLoaded",async()=>{try{y=await O();const e=await f(L,u.UPCOMING_MOVIES);M(e.results)}catch(e){w.innerHTML="<p>Film verileri yüklenemedi.</p>",console.error("Hata:",e)}});async function k(){const e=c.value.trim(),t=T.value;if(e)try{const n=await f(L,u.SEARCH_MOVIES,{query:e,year:t});M(n.results)}catch(n){E.innerHTML="<p>OOPS... We are very sorry! We don`t have any results matching your search. </p>",console.error("Search fetch hatası:",n)}}const b=document.getElementById("clearBtn");c.addEventListener("input",()=>{b.style.display=c.value?"block":"none"});b.addEventListener("click",()=>{c.value="",b.style.display="none",c.focus()});const d=document.getElementById("yearFilter");d.addEventListener("change",function(){for(let t=0;t<d.options.length;t++)d.options[t].style.color="white";for(let t of d.options)t.style.color="",t.style.fontWeight="",t.style.fontSize="";const e=d.options[d.selectedIndex];e.style.color="#F87719",e.style.fontWeight="500",e.style.fontSize="24px"});P.addEventListener("click",k);c.addEventListener("keydown",e=>{e.key==="Enter"&&k()});function x(e,t){const n=document.getElementById("pagination");n.innerHTML="";const s=(a,r,g=!1,p=!1,B=!1)=>{const i=document.createElement("button");return B?i.innerHTML=a:i.textContent=a,p?i.className="nav-btn":(i.className="page-btn",g&&i.classList.add("active")),i.addEventListener("click",async()=>{if(r!==m){m=r;try{const v=await f(L,u.UPCOMING_MOVIES,{page:r});M(v.results),x(r,v.total_pages)}catch(v){E.innerHTML="<p>OOPS... We are very sorry! We don`t have any results matching your search. </p>",console.error("Upcoming fetch hatası:",v)}}}),i};e>1&&n.appendChild(s(`<svg class= "svgNav" width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg>`,e+1,!1,!0,!0))}function F(e,t){var g;window.currentModalMovie=e;const n=document.getElementById("movie-detail-modal"),s=`${C}${u.IMG_W500}${e.poster_path}`,o=((g=e.genre_ids)==null?void 0:g.map(p=>y==null?void 0:y[p]).join(", "))||"N/A",h=I(e.id);n.innerHTML=`
      ...
      <div class="detail-content">
        ...
        <div class="detail-info">
          ...
          <button class="add-library" data-id="${e.id}">
            ${h?"Remove from My Library":"Add to My Library"} </button>
        </div>
      </div>
    </div>

...
function generateStars(vote) {
  ...
  for (let i = 0; i < fullStars; i++) {
    starsHtml += `<img src="./cinemania/src/img/starfull.svg" alt="Full Star" class="star-icon" />`;
  }
  if (hasHalfStar) {
    starsHtml += `<img src="./cinemania/src/img/starhalf.svg" alt="Half Star" class="star-icon" />`;
  }
  for (let i = 0; i < emptyStars; i++) {
    starsHtml += `<img src="./cinemania/src/img/starempty.svg" alt="Empty Star" class="star-icon" />`;
  }
  return starsHtml;
}
